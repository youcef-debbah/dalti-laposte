 ...
 * to the execution hooks ({@link #doFromBackground(Object, Object)}
 ...
 */
@AnyThread
public abstract class DuoDatabaseJob<C1, C2> extends AbstractJob {
     ...
     *                 and {@link #closeFromBackground(Object, Object)})
     */
    protected DuoDatabaseJob(@NonNull final C1 context1, @NonNull final C2 context2) {
     ...
     */
    protected DuoDatabaseJob(@NonNull final AppWorker worker,
     ...
     */
    @MainThread
    protected final void doFromMain(@NonNull final C1 context1, @NonNull final C2 context2) {
     ...
     */
    @MainThread
    protected final void closeFromMain(@NonNull final C1 context1, @NonNull final C2 context2) {
    }
